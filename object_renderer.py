...
class ObjectRenderer:
    def __init__(self, game):
        ...
        self.game_over_image = self.get_texture('resources/textures/game_over.jpg', RES)
        self.win_image = self.get_texture('resources/textures/win.jpg', RES)
    ...
    def load_wall_textures(self):
        return {
            ...
            5: self.get_texture('resources/textures/5.webp'),
